...
flowchart TB
  ...
  quiz: [
    ...
    {q: "La firma digitale di un documento dipende da:", a: ["Solo dal firmatario, come la firma autografa","Dal firmatario E dal contenuto del documento (cambia se cambia anche un solo bit)","Solo dall'algoritmo di hash usato","Solo dalla CA che ha emesso il certificato"], correct: 1, explain: "A differenza della firma autografa, la firma digitale dipende dal contenuto: cambiando anche un solo bit del documento, il digest cambia e quindi la firma. Questo la rende anche un meccanismo di integrità, non solo di autenticazione."},
...
window.CHAPTERS.m1c11 = {
  ...
  quiz: [
    ...
    {q: "Quali di questi sono algoritmi di hash crittografici?", a: ["RSA, AES, DES (sono cifrari, NON hash)","MD5, SHA-1, SHA-256, SHA-3","TCP, UDP, IP","HTTP, FTP, SMTP"], correct: 1, explain: "MD5 e SHA-1 sono storicamente diffusi ma OGGI considerati insicuri (sono state trovate collisioni). Gli standard moderni sicuri sono SHA-256 e SHA-3. RSA/AES/DES sono cifrari, non hash."},
