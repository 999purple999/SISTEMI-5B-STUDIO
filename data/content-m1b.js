...
sequenceDiagram
  ...
  quiz: [
    ...
    {q: "In Diffie-Hellman con N=23, g=5, x=6: quanto vale A = g^x mod N che Alice trasmette?", a: ["A = 8","A = 15","A = 5","A = 23"], correct: 0, explain: "A = 5^6 mod 23 = 15625 mod 23 = 8. Alice trasmette A=8 in chiaro a Bob (e Trudy può intercettarlo, ma non può ricavare x=6 facilmente: è il problema del logaritmo discreto)."},
...
(XOR ancora con la chiave riottiene il chiaro)</code>
  ...
  `,
  quiz: [
    {q: "Quale tecnica crittografica usa il cifrario di Cesare?", a: ["Trasposizione: riordina le lettere in posizioni diverse","Sostituzione mono-alfabetica: ogni lettera è sostituita con quella X posizioni dopo","Sostituzione poli-alfabetica: chiave diversa per ogni posizione","XOR bit-a-bit con una chiave casuale"], correct: 1, explain: "Cesare è un cifrario a sostituzione mono-alfabetica: ogni occorrenza della stessa lettera in chiaro viene SEMPRE sostituita con la stessa lettera cifrata. Per questo è vulnerabile all'analisi statistica: la frequenza delle lettere si conserva."},
    {q: "Cifrario di Cesare con alfabeto di 26 lettere e chiave X=23. Cosa diventa la lettera 'D' (indice 3)?", a: ["A — perché (3+23) mod 26 = 26 mod 26 = 0 → A","Z","C","G"], correct: 0, explain: "Formula: (lettera + X) mod 26. Per D=3: (3+23) mod 26 = 26 mod 26 = 0 = A. Il modulo gestisce il wrap-around: una volta arrivati a Z si riparte da A. Stessa idea con qualsiasi alfabeto circolare."},
