...
window.CHAPTERS.m3c1 = {
  ...
  quiz: [
    ...
    {q: "Cosa significa PUE?", a: ["Power Usage Efficiency / Effectiveness","Public Use Energy","Private Utility Equipment","Power Unit Estimate"], correct: 0, explain: "PUE = energia totale del data center / energia IT. Misura l'efficienza energetica."},
    {q: "Quale PUE è ideale?", a: ["10","2.5","1.0 (più basso possibile)","100"], correct: 2, explain: "PUE = 1.0 sarebbe ideale (tutta l'energia consumata è usata dall'IT)."},
    {q: "Quale di questi NON è una funzione di un data center?", a: ["Hosting siti web","Cloud computing","Solo lavare auto","HPC e AI training"], correct: 2, explain: "Il data center è una struttura informatica: tutte le altre sono funzioni reali."}
  ]
};
