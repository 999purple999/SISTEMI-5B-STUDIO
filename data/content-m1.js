...
sequenceDiagram
  ...
  `,
  quiz: [
    {q: "Quale di queste definizioni descrive meglio la crittografia?", a: ["L'insieme di tecniche che impediscono fisicamente l'intercettazione del segnale sul canale","La scienza che studia tecniche per rendere sicura l'archiviazione e la trasmissione dei dati su canali insicuri","Lo studio degli algoritmi di compressione e codifica dei dati","La disciplina che si occupa di firewall, antivirus e sicurezza degli endpoint"], correct: 1, explain: "La crittografia non protegge il canale fisicamente: rende il messaggio inintelligibile a chi intercetta. Non si occupa di compressione né di sicurezza perimetrale (firewall/antivirus): quelle sono altre branche della cybersecurity."},
...
window.CHAPTERS.m1c2 = {
  ...
  `,
  quiz: [
    {q: "Secondo il principio di Kerckhoffs, cosa NON deve essere segreto in un sistema crittografico?", a: ["La chiave segreta del cifrario","L'algoritmo di cifratura/decifratura: deve essere pubblico per essere validato","L'identità del mittente","Il messaggio in chiaro prima della cifratura"], correct: 1, explain: "Kerckhoffs (1883) inverte la prassi storica: l'ALGORITMO può (anzi, deve) essere pubblico per essere validato dalla comunità scientifica. La sicurezza dipende esclusivamente dalla segretezza della CHIAVE."},
    ...
    {q: "Qual è la differenza chiave tra crittografia simmetrica e asimmetrica?", a: ["Sono identiche, cambia solo il nome","La simmetrica usa UNA chiave segreta condivisa; l'asimmetrica usa una COPPIA pubblica/privata","La simmetrica è più sicura ma più lenta","La simmetrica funziona solo su LAN, l'asimmetrica su Internet"], correct: 1, explain: "Simmetrici (DES, AES): UNA chiave segreta condivisa tra i due interlocutori. Asimmetrici (RSA): DUE chiavi correlate, una pubblica e una privata. La simmetrica è VELOCE ma serve scambio chiave sicuro; l'asimmetrica risolve lo scambio ma è più lenta."},
